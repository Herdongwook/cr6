...
public class SignUpController implements ActionListener {
    ...
    private boolean checkException(UserDTO user) {
        ...
        if (!ExceptionHandling.isPhoneNumber(user.getPhoneNumber())) {
    ...
    private void checkEmail() {
        ...
        String mailPort = "587";
        String mailId = "your-email@gmail.com"; // 구글계정
        String mailPassword = "your-email-password"; // 구글계정 비밀번호

        String fromName = "관리자";
        String fromEmail = "admin@gmail.com"; // 보내는 사람 메일
        String toName = "회원";
